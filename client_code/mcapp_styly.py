...
def ziskej_css_styly():
    ...
    """
    return """
/* ===== MCApp CSS Styles for WSM Results ===== */
...
.mcapp-criteria-table .mcapp-table th:first-child,
.mcapp-variants-table .mcapp-table th:first-child {
  width: 30%;
}
...
/* Responsivní chování pro mobilní zařízení */
...
def vloz_styly_do_html(html_obsah):
    """
    Vloží CSS styly do HTML obsahu.
